    ...
    while True:
        try:
            ...
            if os.environ.get('METRIC_UNITS'):
                ...
                q.put(DisplayModel("Inside temp is: " + str(temp_c) + " " + TempFormat.C.value, .05, [255,255,255], background_color))    
            if os.environ.get('IMPERIAL_UNITS'):
                ...
                q.put(DisplayModel("Inside temp is: " + str(temp_f) + " " + TempFormat.F.value, .05, [255,255,255], background_color))    
